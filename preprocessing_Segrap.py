...
def crop_to_nonzero(data, seg=None, nonzero_label=-1):
    ...
    print('crop_size: ', bbox)

    data = crop_to_bbox(data, bbox)

    return data, bbox

def crop_to_nonzero_2(data, bbox_size, seg=None, nonzero_label=-1):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--target_spacing", type=list, default=[1.5, 1.5, 3.0])
    ...
    for patient_name in patient_names:       
        ...
        json_dict_shape[patient_name] = [spacing_transpose, target_spacing_transpose, origin, direction, raw_shape, resampled_shape, bbox]
